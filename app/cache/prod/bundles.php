...
return array(
    ...
    new OroCRM\Bundle\ActivityContactBundle\OroCRMActivityContactBundle(),
    new OroCRM\Bundle\CRMBundle\OroCRMBundle(),
    ...
    new OroCRM\Bundle\MarketingListBundle\OroCRMMarketingListBundle(),
    new Oro\Bundle\TrackingBundle\OroTrackingBundle(),
    new Oro\Bundle\ReminderBundle\OroReminderBundle(),
    new OroCRM\Bundle\CallBundle\OroCRMCallBundle(),
    new OroCRM\Bundle\CampaignBundle\OroCRMCampaignBundle(),
    new OroCRM\Bundle\ChannelBundle\OroCRMChannelBundle(),
    new OroCRM\Bundle\TaskBundle\OroCRMTaskBundle(),
    new OroCRM\Bundle\AnalyticsBundle\OroCRMAnalyticsBundle(),
    new OroCRM\Bundle\SalesBundle\OroCRMSalesBundle(),
    new OroCRM\Bundle\ContactUsBundle\OroCRMContactUsBundle(),
    new OroCRM\Bundle\MagentoBundle\OroCRMMagentoBundle(),
    new OroCRM\Bundle\CaseBundle\OroCRMCaseBundle(),
);
