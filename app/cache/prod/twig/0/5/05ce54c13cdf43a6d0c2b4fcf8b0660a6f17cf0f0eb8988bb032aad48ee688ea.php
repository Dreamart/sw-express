...
class __TwigTemplate_05ce54c13cdf43a6d0c2b4fcf8b0660a6f17cf0f0eb8988bb032aad48ee688ea extends Twig_Template
{
    ...
    public function block_a2lix_translations_gedmo_widget($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["translationsLocales"]) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["translationsFields"]) {
                ...
                echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, (isset($context["locale"]) ? $context["locale"] : null)), "html", null, true);
                echo " ";
                if ((isset($context["isDefaultLocale"]) ? $context["isDefaultLocale"] : null)) {
                    echo "[Default]";
                }
                // line 39
                echo "                    </a>
