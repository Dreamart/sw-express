 ...
 */
class LeadMailboxProcessSettings extends \OroCRM\Bundle\SalesBundle\Entity\LeadMailboxProcessSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'owner', 'channel', 'source', 'id', 'mailbox');
        }
