 ...
 */
class Address extends \OroCRM\Bundle\MagentoBundle\Entity\Address implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'label', 'street', 'street2', 'city', 'postalCode', 'country', 'region', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'owner', 'phone', 'types', 'contactAddress', 'contactPhone', 'syncState', 'primary', 'id', 'organization', 'created', 'updated', 'channel', 'originId');
        }
     ...
     * {@inheritDoc}
     */
    public function setOwner(\OroCRM\Bundle\MagentoBundle\Entity\Customer $owner = NULL)
    {
