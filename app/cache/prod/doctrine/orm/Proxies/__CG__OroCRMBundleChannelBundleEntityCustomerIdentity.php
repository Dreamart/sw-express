 ...
 */
class CustomerIdentity extends \OroCRM\Bundle\ChannelBundle\Entity\CustomerIdentity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'account', 'contact', 'owner', 'createdAt', 'updatedAt', 'dataChannel');
        }
     ...
     * {@inheritDoc}
     */
    public function setContact(\OroCRM\Bundle\ContactBundle\Entity\Contact $contact)
    {
