...
class IndexText extends \Oro\Bundle\SearchBundle\Entity\IndexText implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexText' . "\0" . 'id', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexText' . "\0" . 'item', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexText' . "\0" . 'field', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexText' . "\0" . 'value');
        }
