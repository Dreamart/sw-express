 ...
 */
class CasePriority extends \OroCRM\Bundle\CaseBundle\Entity\CasePriority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'order', 'label', 'locale');
        }
    ...
    public function isEqualTo($other)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isEqualTo', array($other));
