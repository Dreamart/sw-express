 ...
 */
class MarketingListUnsubscribedItem extends \OroCRM\Bundle\MarketingListBundle\Entity\MarketingListUnsubscribedItem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'entityId', 'marketingList', 'createdAt');
        }
