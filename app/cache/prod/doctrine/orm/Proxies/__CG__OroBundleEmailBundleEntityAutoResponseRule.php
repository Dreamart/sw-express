...
class AutoResponseRule extends \Oro\Bundle\EmailBundle\Entity\AutoResponseRule implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'active', 'conditions', 'template', 'mailbox', 'createdAt');
        }
    ...
    public function addConditions(array $conditions)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addConditions', array($conditions));
     ...
     * {@inheritDoc}
     */
    public function addCondition(\Oro\Bundle\EmailBundle\Entity\AutoResponseRuleCondition $condition)
    {
     ...
     * {@inheritDoc}
     */
    public function removeCondition(\Oro\Bundle\EmailBundle\Entity\AutoResponseRuleCondition $condition)
    {
