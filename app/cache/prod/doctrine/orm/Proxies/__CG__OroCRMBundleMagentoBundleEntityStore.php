 ...
 */
class Store extends \OroCRM\Bundle\MagentoBundle\Entity\Store implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'name', 'website', 'channel', 'originId');
        }
