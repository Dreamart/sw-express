...
class TrackingWebsite extends \Oro\Bundle\TrackingBundle\Entity\TrackingWebsite implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'identifier', 'name', 'url', 'owner', 'createdAt', 'updatedAt', 'organization', 'channel');
        }
    ...
    public function setChannel($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChannel', array($value));
