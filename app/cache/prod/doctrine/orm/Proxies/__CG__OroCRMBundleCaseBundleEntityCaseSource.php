 ...
 */
class CaseSource extends \OroCRM\Bundle\CaseBundle\Entity\CaseSource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'label', 'locale');
        }
