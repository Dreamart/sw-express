...
class InternalEmailOrigin extends \Oro\Bundle\EmailBundle\Entity\InternalEmailOrigin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'internalName', 'id', 'mailboxName', 'folders', 'isActive', 'syncCodeUpdatedAt', 'synchronizedAt', 'syncCode', 'syncCount', 'owner', 'organization', 'mailbox');
        }
