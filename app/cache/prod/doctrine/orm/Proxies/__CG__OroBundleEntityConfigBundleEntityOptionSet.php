 ...
 */
class OptionSet extends \Oro\Bundle\EntityConfigBundle\Entity\OptionSet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setData($id, $priority, $label, $default)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setData', array($id, $priority, $label, $default));

        return parent::setData($id, $priority, $label, $default);
    }
