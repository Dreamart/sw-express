...
class Query extends \Oro\Bundle\SearchBundle\Entity\Query implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\Query' . "\0" . 'id', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\Query' . "\0" . 'entity', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\Query' . "\0" . 'query', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\Query' . "\0" . 'resultCount', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\Query' . "\0" . 'createdAt');
        }
    ...
    public function setResultCount($resultCount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setResultCount', array($resultCount));
