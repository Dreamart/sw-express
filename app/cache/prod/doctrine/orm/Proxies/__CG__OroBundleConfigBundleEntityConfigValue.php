...
class ConfigValue extends \Oro\Bundle\ConfigBundle\Entity\ConfigValue implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'config', 'section', 'textValue', 'objectValue', 'arrayValue', 'type', 'createdAt', 'updatedAt');
        }
    ...
    public function clearValue()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearValue', array());
