 ...
 */
class CartAddress extends \OroCRM\Bundle\MagentoBundle\Entity\CartAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'phone', 'street', 'city', 'postalCode', 'country', 'region', 'id', 'label', 'street2', 'organization', 'regionText', 'namePrefix', 'firstName', 'middleName', 'lastName', 'nameSuffix', 'created', 'updated', 'channel', 'originId');
        }
