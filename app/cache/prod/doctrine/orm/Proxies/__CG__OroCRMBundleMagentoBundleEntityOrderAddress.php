 ...
 */
class OrderAddress extends \OroCRM\Bundle\MagentoBundle\Entity\OrderAddress implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'types', 'owner', 'fax', 'phone', 'street', 'city', 'postalCode', 'country', 'region', 'label', 'namePrefix', 'middleName', 'nameSuffix', 'street2', 'primary', 'created', 'updated', 'id', 'organization', 'regionText', 'firstName', 'lastName', 'channel', 'originId');
        }
     ...
     * {@inheritDoc}
     */
    public function setOwner(\OroCRM\Bundle\MagentoBundle\Entity\Order $owner)
    {
