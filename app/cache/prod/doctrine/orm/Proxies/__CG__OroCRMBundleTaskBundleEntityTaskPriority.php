 ...
 */
class TaskPriority extends \OroCRM\Bundle\TaskBundle\Entity\TaskPriority implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'name', 'label', 'order');
        }
