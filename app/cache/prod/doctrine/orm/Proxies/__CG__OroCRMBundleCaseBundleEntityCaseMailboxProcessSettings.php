 ...
 */
class CaseMailboxProcessSettings extends \OroCRM\Bundle\CaseBundle\Entity\CaseMailboxProcessSettings implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'owner', 'assignTo', 'priority', 'status', 'tags', 'id', 'mailbox');
        }
