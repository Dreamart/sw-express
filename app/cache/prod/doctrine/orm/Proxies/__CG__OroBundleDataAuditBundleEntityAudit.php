...
class Audit extends \Oro\Bundle\DataAuditBundle\Entity\Audit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'loggedAt', 'objectId', 'objectClass', 'objectName', 'version', 'fields', 'username', 'user', 'data', 'organization', 'action');
        }
    ...
    public function getDeprecatedData()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeprecatedData', array());

        return parent::getDeprecatedData();
    }
    ...
    public function createField($field, $dataType, $newValue, $oldValue)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'createField', array($field, $dataType, $newValue, $oldValue));

        return parent::createField($field, $dataType, $newValue, $oldValue);
    }
