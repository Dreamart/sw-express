 ...
 */
class CasePriorityTranslation extends \OroCRM\Bundle\CaseBundle\Entity\CasePriorityTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'foreignKey', 'content', 'id', 'locale', 'objectClass', 'field');
        }
