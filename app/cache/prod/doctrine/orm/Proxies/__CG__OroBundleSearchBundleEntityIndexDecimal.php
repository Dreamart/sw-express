...
class IndexDecimal extends \Oro\Bundle\SearchBundle\Entity\IndexDecimal implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexDecimal' . "\0" . 'id', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexDecimal' . "\0" . 'item', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexDecimal' . "\0" . 'field', '' . "\0" . 'Oro\\Bundle\\SearchBundle\\Entity\\IndexDecimal' . "\0" . 'value');
        }
     ...
     * {@inheritDoc}
     */
    public function setItem(\Oro\Bundle\SearchBundle\Entity\Item $item = NULL)
    {
