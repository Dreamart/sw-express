 ...
 */
class ConfigLogDiff extends \Oro\Bundle\EntityConfigBundle\Entity\ConfigLogDiff implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'log', 'className', 'fieldName', 'scope', 'diff');
        }
    ...
    public function setDiff(array $configs)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDiff', array($configs));
