 ...
 */
class Group extends \OroCRM\Bundle\ContactBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', 'owner', 'organization');
        }
    ...
    public function setLabel($name)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabel', array($name));
