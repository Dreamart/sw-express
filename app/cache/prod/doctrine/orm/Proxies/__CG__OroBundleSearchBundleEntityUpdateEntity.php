 ...
 */
class UpdateEntity extends \Oro\Bundle\SearchBundle\Entity\UpdateEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'entity');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UpdateEntity $proxy) {
