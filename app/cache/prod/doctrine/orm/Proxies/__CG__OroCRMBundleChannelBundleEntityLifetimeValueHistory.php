 ...
 */
class LifetimeValueHistory extends \OroCRM\Bundle\ChannelBundle\Entity\LifetimeValueHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'status', 'dataChannel', 'account', 'amount', 'createdAt');
        }
     ...
     * {@inheritDoc}
     */
    public function setAccount(\OroCRM\Bundle\AccountBundle\Entity\Account $account)
    {
